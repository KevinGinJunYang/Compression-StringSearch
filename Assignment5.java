	...
	private void initialise() {
		...
		searchField.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int index = new KMP(pattern, text).searchBoyerMoore(pattern, text);
				//int index = new KMP(pattern, text).searchBruteForce(pattern, text);
				//int index = new KMP(pattern, text).searchKMP(pattern, text);
